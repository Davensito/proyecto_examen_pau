...
import com.example.minispotify.activity.ArtistaActivity
...
class CancionArtistaAdapter(private var cancionesEntity: MutableList<CancionEntity>, private val listener: ArtistaActivity):
    RecyclerView.Adapter<CancionArtistaAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CancionArtistaAdapter.ViewHolder, position: Int) {
