...
class FavSongsAdapter(private var cancionesEntity: MutableList<CancionEntity>, private val listener: FavSongsActivity):
    RecyclerView.Adapter<FavSongsAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: FavSongsAdapter.ViewHolder, position: Int) {
